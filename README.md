...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/arlpy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8257&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/arlpy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `arlpy` can be installed with:

```
conda install arlpy
```

It is possible to list all of the versions of `arlpy` available on your platform with:
